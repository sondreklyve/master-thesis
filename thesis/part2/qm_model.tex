...
Eq.~\eqref{eq:Lqschematic} makes explicit the elements of QCD that
...
\begin{equation}
U(2)_L \times U(2)_R
\approx SU(2)_L \times SU(2)_R \times U(1)_V \times U(1)_A .
\end{equation}
...
To analyse the vacuum structure we work at tree level and neglect
...
Fig.~\ref{fig:mexican_hat} illustrates this structure in the chiral
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/quark_meson/mexican_hat.pdf}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/quark_meson/tilt_profile.pdf}
...
number are energetically favoured, and once $\mu_f$ exceeds the
...
condensate.
At zero temperature, such a condensate becomes energetically favoured
