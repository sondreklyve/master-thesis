...
% The physical inputs used later are
% \begin{equation}
% f_\pi = 93\,\mathrm{MeV}, \qquad
% m_\pi = 138\,\mathrm{MeV}, \qquad
% m_\sigma \simeq 500\text{--}600\,\mathrm{MeV}, \qquad
% M_q \simeq 300\,\mathrm{MeV},
% \end{equation}
% where $f_\pi$ and $m_\pi$ are experimental inputs \cite{PDG}, while
% $m_\sigma$ and $M_q$ are standard phenomenological values used in
% chiral quark-model studies
% \cite{SchaeferWambach2008,Buballa2005}.
