...
for connecting microscopic physics to macroscopic thermodynamic properties
\cite{PeskinSchroeder1995,Weinberg1995}.

The need for quantum field theory arises from the limitations of
...
These issues can be illustrated with simple thought experiments. A particularly
clear example is provided by the relativistic boosting of a particle confined
...
example provides a concrete and physically transparent motivation for quantum
field theory \cite{Vutha_2013}.

Quantum field theory resolves these problems by promoting particles to
...
\cite{PeskinSchroeder1995}. More generally, quantum field theory provides a
unified framework in which quantum mechanics and special relativity are combined
in a consistent and predictive manner.

For the study of dense matter, quantum field theory is particularly useful
...
sections, the basic concepts of quantum field theory relevant for this work will
...
that connects ordinary quantum mechanics to quantum field theory. The emphasis
...
functions. For example, the time-ordered two-point function
\begin{equation}
\langle T\, q(t)\, q(t') \rangle
\end{equation}
encodes information about the propagation and fluctuations of the quantum
degree of freedom. This viewpoint generalizes directly to field theory, where
correlation functions play a central role.

\subsection*{Generating functionals}

A convenient way to organize correlation functions is through the introduction
of an external source. In quantum mechanics, one defines the generating
functional
\begin{equation}
...
\end{equation}
where $J(t)$ is a classical source coupled linearly to the coordinate $q(t)$.
Time-ordered correlation functions are then obtained by functional derivatives
...
\right|_{J=0}.
\end{equation}
The generating functional thus contains complete information about the quantum
dynamics of the system. This construction extends straightforwardly to quantum
field theory, where the source becomes a function of spacetime.

\subsection*{From particles to fields}

The transition from quantum mechanics to quantum field theory amounts to
...
In the path-integral formulation of quantum field theory, the generating
...
quantum field theory. It treats space and time on an equal footing, makes the
...
\section{Interacting scalar fields: the $\phi^4$ theory}
