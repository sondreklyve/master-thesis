...
The aim of this work has been to develop a coherent description of
neutron--star structure, beginning with hydrostatic equilibrium in general
relativity and ending with a self--consistent calculation of dense matter in
the relativistic mean--field \(npe\mu\) model. Each step in this progression
served to show how microphysical assumptions about matter translate into
macroscopic predictions for neutron--star mass--radius relations.
...
The principal part of the project was the implementation and study of the
