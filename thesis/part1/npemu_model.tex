...
composition of $npe\mu$ matter, and then use it to construct and analyze the
...
$n_{\mu}$ rather than pushing $\mu_{e}$ to ever larger values. This behavior
...
provides the physically consistent low-density behavior and ensures that the
...
inspection as $\Gamma = 1.2$. This value gives a low-density behavior
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/npemu/poly_mr}
...
neutron-rich nuclei become energetically favoured. Each change of the
...
polytrope. The crust part of the EoS (blue curve in
...
\begin{figure}[htbp]
  ...
  \caption[Crust + core equation of state]{
    ...
    core. The crust (blue curve) reproduces the sequence of low-density
...
This behavior reflects the fact that the $\Gamma=1.2$ polytrope has
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{figures/npemu/crust_mr}
...
while the FPS crust supplies the correct microphysical behavior at
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/npemu/eos_band}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/npemu/mr_band_obs}
