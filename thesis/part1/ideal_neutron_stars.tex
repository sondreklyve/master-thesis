...
The aim of this chapter is to construct and analyse such ideal neutron
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ideal_neutron_stars/mass_radius_ideal_neutron_star.pdf}
...
Sletmoen~\cite{sletmoen2022}, used to analyse the stability of the ideal neutron star
sequence.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/ideal_neutron_stars/shoot_shoot_relative.pdf}
