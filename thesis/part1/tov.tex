...
compact stars beyond which no stable configuration exists.

The derivation follows Carroll’s \emph{Spacetime and Geometry} \cite{oppenheimer1939, tolman1939, carroll}.

\section{Metric ansatz and coordinates}
We now restrict ourselves to static, spherically symmetric stellar configurations. 
...
In relativistic astrophysics, stellar matter is commonly modelled as a
perfect fluid --- an idealized medium with no viscosity or heat conduction,
characterized entirely by its local rest--frame energy density $\epsilon$
and isotropic pressure $P$. While real nuclear matter may exhibit more
