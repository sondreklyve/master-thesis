...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{figures/ideal_fermi_gas/fermi_eos.pdf}
...
collapse: degeneracy pressure. Its relevance is illustrated most clearly by
white dwarfs and neutron stars.

In white dwarfs, the pressure support is provided almost entirely by degenerate
electrons. As the central density increases, the electron Fermi momentum can
approach or exceed the rest mass, \(p_F \gtrsim m_e\), driving the gas into the
relativistic regime. The equation of state then approaches \(P=\epsilon/3\),
and the stellar mass becomes nearly independent of radius. Balancing this
pressure against gravity gives the Chandrasekhar mass limit,
\(M_{\rm Ch} \simeq 1.4\,M_\odot\). Although derived under the idealized
assumptions of a cold, non--interacting electron gas, with ions contributing
only to the rest--mass density, this estimate is close to the observed upper
masses of white dwarfs.

For neutron stars, the same physical idea applies, but with important
differences. Oppenheimer and Volkoff modelled neutron stars as a cold, ideal
Fermi gas of neutrons with relativistic dispersion relation
...
this is far below the \(\sim 2\,M_\odot\) neutron stars observed
today~\cite{haensel2007}, the calculation was historically crucial: it showed
that general relativity combined with a microscopic equation of state naturally
produces an upper mass limit, analogous to the Chandrasekhar limit for white
dwarfs.

The ideal Fermi gas nevertheless neglects several important physical
ingredients. Real neutron-star matter is strongly interacting, charge neutrality
and beta equilibrium require a mixture of neutrons, protons, electrons, and
muons, and exotic components may appear at sufficiently high densities. Finite
temperature effects can also matter in newly born protoneutron stars. These
effects modify the equation of state and hence the predicted stellar structure.

Despite these limitations, the ideal Fermi gas remains a valuable baseline
model. It provides analytic control in limiting regimes, a clear physical
picture of degeneracy pressure, and a simple equation of state that can be
coupled directly to the TOV equations. Its predictions, such as the
Chandrasekhar and Oppenheimer--Volkoff mass limits, show that even this
simplified treatment captures the correct order of magnitude for compact-star
maximum masses.
